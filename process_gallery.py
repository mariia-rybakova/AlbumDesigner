...
def process_message(message, logger):
    ...
    try:
        ...
        for key, value in first_last_pages_data_dict.items():
            if first_last_pages_data_dict[key]['images_df'] is not None and first_last_pages_data_dict[key]['images_df'].shape[0] != 0:
...
if __name__ == '__main__':
    ...
    # _input_request = {'replyQueueName': 'devaigeneratealbumresponsedto', 'storeId': 32, 'accountId': 412600, 'projectId': 46670335, 'userId': 570939077, 'userJobId': 1111317004, 'base_url': 'ptstorage_32://pictures/46/670/46670335/hykjp6q0hzt8zh2m7a', 'photos': [10900744896, 10900744906, 10900744902, 10900744897, 10900744898, 10900744903], 'projectCategory': 1, 'compositionPackageId': -1, 'designInfo': None, 'designInfoTempLocation': 'pictures/temp/devaigeneratealbumdto/euig11nnqecmi6q_estp67dx.json', 'aiMetadata': None, 'conditionId': 'AAD_46670335_a67372bb-349e-46f0-a83b-8481de60f7d8.85.64', 'timedOut': False, 'dependencyDeleted': False, 'retryCount': 1}
    ...
    _images_path = f'/home/a.hyryla/data/pic_time/imagesets/testing/{_input_request["projectId"]}/'
    _output_pdf_path = f'/home/a.hyryla/data/pic_time/results/processed_imagesets/testing/{_input_request["projectId"]}'
