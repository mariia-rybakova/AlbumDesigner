...
from src.groups_operations.groups_management import process_illegal_groups,process_wedding_illegal_groups
...
def album_processing(df, designs_info, is_wedding, modified_lut, params, logger , density=3):
    ...
    if is_wedding:
        ...
        updated_groups, group2images, = process_wedding_illegal_groups(df, look_up_table, is_wedding, logger)
