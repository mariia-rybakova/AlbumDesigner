...
def generate_query(tags_file, images_data_dict):
    ...
    with open(tags_file, 'rb') as f:
        loaded_tags_features = pickle.load(f)
    ...
    for image in images_data_dict:
        ...
        images_data_dict[image].update({'image_query_content': max_value_tag,'image_subquery_content': tags_similarities[max_value_tag][1]})
